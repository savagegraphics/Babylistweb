    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-7xl py-8 sm:px-6 sm:py-12 lg:px-8">
                <div className="relative isolate overflow-hidden bg-custom-D14D72 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                    <svg
                    ...
                    <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                            ...
                            <a href="#" className="text-sm font-semibold leading-6 text-white">
                                Find a Babylist Registry<span aria-hidden="true">→</span>
                            </a>
                        </div>
                    </div>
